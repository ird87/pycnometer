...
class UiFileManager(QWidget):
    ...
    def add_files(self, files):
        for f in files:
            ...
            item1 = QtWidgets.QTableWidgetItem(f)
            ...
            data_changed = files[f]
            item2 = QtWidgets.QTableWidgetItem(data_changed)
    ...
    def activate(self):
        ...
        # self.languages(self.parent.FileManagerHeader)
        # Отображаем форму
        self.show()
        # Размещаем по центру
